...
- **🖼️ อ่านเนื้อหาจากรูปภาพ:** หน้าที่มีไดอะแกรม กราฟ หรือแผนภาพ จะถูกส่งให้ AI วิเคราะห์ด้วยความสามารถด้านภาพ (vision) ทำให้ไม่พลาดเนื้อหาที่อยู่ในรูป
- **🧠 สรุปเนื้อหาด้วย AI:** สร้างสรุปที่มีโครงสร้างชัดเจนอัตโนมัติ (ภาพรวม, ประเด็นสำคัญ, เนื้อหาเจาะลึกแยกหัวข้อ และตัวเลขสำคัญ)
- **📚 รองรับเอกสารขนาดยาว:** ใช้สถาปัตยกรรม Map-Reduce ร่วมกับการแบ่งเนื้อหาตามขอบเขตหัวข้อ (semantic chunking) ทำให้อ่านครบทุกหน้าโดยไม่ตัดเนื้อหาทิ้ง
- **📝 สร้างข้อสอบอัจฉริยะ:** สร้างข้อสอบปรนัย (4/5/6 ตัวเลือก) และถูก/ผิด เลือกระดับความยากได้ 3 ระดับ พร้อมกระจายคำถามให้ครอบคลุมทั้งเอกสารและป้องกันคำถามซ้ำ
- **💬 ถาม-ตอบจากบริบท:** สอบถามข้อมูลจากเอกสารที่อัปโหลด ระบบจะคัดเลือกเฉพาะส่วนที่เกี่ยวข้องมาตอบ พร้อมระบุหน้าที่ใช้อ้างอิง
- **☁️ คลังเก็บข้อมูลบน Cloud:** ประวัติการใช้งาน, โน้ตย่อ และคลังข้อสอบส่วนตัว จะถูกเก็บรักษาไว้อย่างปลอดภัยบน **Firestore** ทำให้ซิงค์ข้อมูลข้ามอุปกรณ์และพร้อมรองรับสถาปัตยกรรมระดับ PaaS
- **🖨️ Export เป็น PDF:** นำออกชุดข้อสอบที่สร้างขึ้นมาเป็นไฟล์ PDF ที่จัดหน้าไว้อย่างสวยงาม รองรับภาษาไทย

## 🛠️ เทคโนโลยีที่ใช้ (Tech Stack)

- **Backend:** Python 3, FastAPI, Pydantic, OpenAI API, Firebase Admin SDK, PyMuPDF, ReportLab
...
AI_MODEL=gpt-4o-mini              # เปลี่ยนโมเดลได้ที่นี่โดยไม่ต้องแก้โค้ด
...
> **หมายเหตุ:** ต้องเปิดใช้งาน virtual environment ก่อนรันเสมอ มิฉะนั้นระบบอาจหาไลบรารีที่ติดตั้งไว้ไม่พบ
